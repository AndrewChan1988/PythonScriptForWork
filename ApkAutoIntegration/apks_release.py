        ...
        for apk in apk_lists:
            if is_resolution is True:
                if "universal" in apk and "release" in apk and "unsigned" in apk:
                    ...
                    if project_name == "SysStasl_Plt":
                        dst = apk_release_path + "\\" + baseline + "\\" + "SysStasl.apk"
                    else:
...
if __name__ == '__main__':
    ...
    product_names = sys.argv[4].split(",")
...
'''.format(project_name + ".apk", baseline, resolution, product_name, branch)
        ...
        print("正在将apk发布到{0}".format(product_name))
        ...
        print("APK发布成功！！！\n")
        print("发布地址为：{0}".format(apk_release_path + "\\" + baseline))
        print("*****************************************************************************************\n\n\n\n")
